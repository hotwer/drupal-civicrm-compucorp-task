<?php /* Smarty version 2.6.27, created on 2016-09-14 06:44:58
         compiled from CRM%5COrganisationactivities%5CPage%5COrganisationActivities.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM\\Organisationactivities\\Page\\OrganisationActivities.tpl', 1, false),array('block', 'ts', 'CRM\\Organisationactivities\\Page\\OrganisationActivities.tpl', 4, false),array('modifier', 'crmAddClass', 'CRM\\Organisationactivities\\Page\\OrganisationActivities.tpl', 9, false),array('function', 'crmURL', 'CRM\\Organisationactivities\\Page\\OrganisationActivities.tpl', 38, false),)), $this); ?>
...
"<?php echo ';
        CRM.$(\'table.contact-activity-selector-\' + context).data({
          "ajax": {
            "url": '; ?>
'<?php echo CRM_Utils_System::crmURL(array('p' => "civicrm/ajax/organisationactivities",'h' => 0,'q' => "snippet=4&context=".($this->_tpl_vars['context'])."&cid=".($this->_tpl_vars['contactId'])), $this);?>
'<?php echo ',
            "data": function (d) {
