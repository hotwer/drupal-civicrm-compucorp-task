...
require_once 'CRM_Core_Selector_Base';
require_once 'CRM_Core_Selector_API';

/**
 * This class is used to retrieve and display activities for a contact.
 */
class CRM_Organisationactivities_Selector_Organisationactivities extends CRM_Core_Selector_Base implements CRM_Core_Selector_API {
